    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <!-- /.box-footer-->
         ...
         <div class="box">
         <div class="box-header with-border">
              <h3 class="box-title">Chi tiết màn hình</h3>
            </div>
        <div class="box-body" id="screendtls">
          ...
          ?>
            <table class="table table-bordered table-hover">
              ...
              <th class="col-md-3">Tên màn hình</th>
              <th class="col-md-1">Ghế ngồi</th>
              <th class="col-md-1">Thù lao</th>
              <th class="col-md-3">Hiển thị thời gian</th>
              <th class="text-right col-md-3"><button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i>Thêm màn hình</button></th>
                <?php 
                $sl=1;
                while($screen=mysqli_fetch_array($sr))
                {
                  ...
                  <tr>
                    ...
                    ?></td>
                    <td class="text-right"><button data-toggle="modal" data-id="<?php echo $screen['screen_id'];?>" data-target="#view-modal2" id="getUser2" class="btn btn-sm btn-warning"><i class="fa fa-plus"></i>Thêm thời gian hiển thị</button></td>
                  </tr>
                  <?php
                  $sl++;
                }
            ...
            {
              ?>
              <button data-toggle="modal" data-target="#view-modal" id="getUser" class="btn btn-sm btn-info"><i class="fa fa-plus"></i>Thêm màn hình</button>
                  ...
                  <div class="modal-content"> 
                       ...
                       <div class="modal-header"> 
                            ...
                            <h4 class="modal-title">
                            	<i class="fa fa-plus"></i>Thêm màn hình
                            </h4> 
                       </div> 
             ...
             <div class="modal-dialog"> 
                  <div class="modal-content"> 
                       ...
                       <div class="modal-header"> 
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">
                            	<i class="fa fa-plus"></i>Thêm thời gian hiển thị
                            </h4> 
                       </div> 
                       <div class="modal-body"> 
