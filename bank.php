...
<div id="mainContainer" class="row large-centered">
  ...
  <div class="text-center"><h2>Thanh toán</h2></div>
  
  <hr class="divider">
  <dl class="mercDetails">
  	<dt>Người đặt hàng</dt> 				<dd>Shop Street</dd>
    <dt>Số tiền</dt> 	<dd>INR <?php echo  $_SESSION['amount'];?></dd>
    <dt>Thẻ ghi nợ</dt> 		<dd><?php echo  $number;?></%></dd>
  </dl>
  <hr class="divider">
...
<p class="form-subheading">OTP được gửi tới số điện thoại có đuôi<strong>1343</strong></p>
...
<a class="tryAgain" href="complete_order.jsp">Quay trở lại</p></a>
</p>
</fieldset>
