		...
		<div class="content-top">
				<div class="section group">
					<div class="about span_1_of_2">	
						<h3 style="color:black;" class="text-center">LỊCH SỬ ĐẶT CHỖ</h3>
				...
				{
					?>
					<h3 style="color:red;" class="text-center">Không tìm thấy đặt chỗ trước đó!</h3>
					<p>Khi bạn bắt đầu đặt vé xem phim bằng tài khoản này, bạn sẽ có thể xem toàn bộ lịch sử đặt vé.</p>
					<?php
				}
				?>
					</div>			
