						...
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									...
									<p class="p-link" style="font-size:15px"><b>Ngày phát hành: </b><?php echo date('d-M-Y',strtotime($movie['release_date'])); ?></p>
							...
							<table class="table table-hover table-bordered text-center">
								<h3 style="color:#444;" class="text-center">Chương trình có sẵn</h3>

								<thead>
										<tr>
											<th class="text-center" style="font-size:16px;"><b>Rạp</b></th>
											<th class="text-center" style="font-size:16px;"><b>Thời gian</b></th>
										</tr>
									</thead>
							<?php
